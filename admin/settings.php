...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $_POST['site_logo'] = ru_admin_upload('site_logo_file', 'brand') ?: ($_POST['site_logo'] ?? '');
        $_POST['site_favicon'] = ru_admin_upload('site_favicon_file', 'brand') ?: ($_POST['site_favicon'] ?? '');
    } catch (Throwable $e) {
...
ob_start();
?>
<section class="admin-panel"><div class="admin-panel__head"><h2>Ayarlar</h2></div><form class="admin-form" method="post" enctype="multipart/form-data"><?= ru_csrf_field() ?>
