<?php
/**
 * Placeholder — henuz aktiflesmemis bolumler (Urunler, 2.El)
 */
declare(strict_types=1);

$title = $placeholder_title ?? 'Yakinda';
$msg   = $placeholder_message ?? 'Bu bolum yakinda yayina alinacak.';
?>
...
<section class="placeholder section">
  <div class="container container--narrow">
    <div class="placeholder__card">
      ...
      <h2 class="placeholder__title">Yapim asamasinda</h2>
      <p class="placeholder__text">
        <?= h($msg) ?> Bu sirada urunlerimiz, hizmetlerimiz veya bayilik basvurulariniz icin
        bizimle dogrudan iletisime gecebilirsiniz.
      </p>
      <div class="placeholder__cta">
        <a class="btn btn--primary btn--lg" href="/iletisim">Iletisime Gec</a>
        <a class="btn btn--ghost btn--lg" href="/">Anasayfaya Don</a>
      </div>
    </div>
  </div>
</section>
